    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 20 }}>
          ...
          <p style={{ fontSize: 13, color: 'var(--muted)', marginTop: 4 }}>Even 30 seconden — de basis van hoe dit werkt.</p>
        </div>

        {/* 3 core steps */}
        <div style={{ marginBottom: 24 }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--accent1)', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 10 }}>Stap voor stap</div>
        ...
        {/* Knop uitleg */}
        <div style={{ marginBottom: 24 }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--accent1)', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 10 }}>De 3 &quot;niet bellen&quot; knoppen</div>

          <ActionButton icon={<Repeat size={16} />} name="Skip →" color="var(--muted)"
        ...
        {/* Queue uitleg */}
        <div style={{ padding: 14, background: 'var(--sidebar-active-bg)', borderRadius: 12, marginBottom: 20, fontSize: 13, lineHeight: 1.5 }}>
          <strong style={{ color: 'var(--accent1)' }}>💡 Hoe krijg je de volgende lead?</strong>
...
function ActionButton({ icon, name, color, desc }: any) {
  return (
    <div style={{ display: 'flex', gap: 10, marginBottom: 10, alignItems: 'flex-start' }}>
      ...
      <p style={{ flex: 1, fontSize: 12, color: 'var(--muted)', lineHeight: 1.5 }}>{desc}</p>
    </div>
  )
}
